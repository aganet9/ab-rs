...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleValidation(MethodArgumentNotValidException ex) {
        Map<String, String> response = new HashMap<>();
        ex.getBindingResult().getFieldErrors().forEach((error) -> response.put(error.getField(),
    ...
    @ExceptionHandler(ProductCategoryNotMatchException.class)
    public ResponseEntity<Map<String, String>> handleProductCategoryNotMatch(ProductCategoryNotMatchException ex) {
        Map<String, String> response = new HashMap<>();
        response.put("error", ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
